...
| [dongwei6688/weread-notes-export-skill](https://github.com/dongwei6688/weread-notes-export-skill) | Hermes / OpenClaw / 跨 runtime | 按章节树导出划线/评论为本地 Markdown，支持增量同步、同名合并、分隔线格式。纯 Python 标准库，零依赖。 |
...
| [chanity256/weread-export](https://github.com/chanity256/weread-export) | macOS / Markdown / Obsidian | macOS 定时导出器：每天扫描已读完且有笔记的书，把划线、想法和书评写成 Obsidian 兼容 Markdown。 | [记录](docs/promo/runs/2026-06-08/chanity256-weread-export/summary.md) · [产物](docs/promo/runs/2026-06-08/chanity256-weread-export/artifacts/sample-export.md) |
| [a3100821009/weread-to-notion](https://github.com/a3100821009/weread-to-notion) | Python, Notion | 将微信读书的书架、划线、想法、阅读统计数据同步到 Notion。 | [记录](docs/promo/runs/2026-06-02/a3100821009-weread-to-notion/summary.md) · [产物](docs/promo/runs/2026-06-02/a3100821009-weread-to-notion/artifacts/candidate-evidence.md) |
...
| [chucan1/weread-to-getnote](https://github.com/chucan1/weread-to-getnote) | Get 笔记 | Claude Code Skill，把微信读书划线和想法整理后导入 Get 笔记，并按知识库推荐归档。 | [记录](docs/promo/runs/2026-05-29/chucan1-weread-to-getnote/summary.md) · [产物](docs/promo/runs/2026-05-29/chucan1-weread-to-getnote/artifacts/getnote-import-preview.md) |
