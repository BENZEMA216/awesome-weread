# TianLanhe/weread-readdata-for-tencent-doc 体验记录（离线 smoke test）

- 项目：https://github.com/TianLanhe/weread-readdata-for-tencent-doc
- 分类：第三方同步
...
~~~bash
git clone https://github.com/TianLanhe/weread-readdata-for-tencent-doc /tmp/TianLanhe-weread-readdata-for-tencent-doc-run
cd /tmp/TianLanhe-weread-readdata-for-tencent-doc-run
~~~
...
“读书数据 → 腾讯文档”适合团队共享与可视化汇总：把年度/月份阅读时长、天数等指标同步进表格后，便于做图、做周报月报。本次示例先把最小的表格落地格式固定下来（CSV 可导入），后续接入真实脚本即可自动更新。
