...
./CLAUDE.md:24:WEREAD_API_KEY=wrk-xxx node dist/cli.js shelf       # 真实跑接口
...
./README.md:26:export WEREAD_API_KEY=<你的 apikey>
./README.md:53:const weread = new OpenWeRead({ apiKey: "" }); // 读取 WEREAD_API_KEY
./src/errors.ts:17:    message = '未设置 WEREAD_API_KEY，请获取 https://weread.qq.com/r/weread-skills，并执行: export WEREAD_API_KEY=<你的apikey>',
...
./openweread-skills/SKILL.md:29:export WEREAD_API_KEY=<your_api_key>
...
./weread-skills/SKILL.md:40:- 若未设置，提示用户：`export WEREAD_API_KEY=<你的apikey>`
