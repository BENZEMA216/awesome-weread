...
./scripts/weread.sh:34:  or export WEREAD_API_KEY=<your-api-key>
./scripts/weread.sh:129:if [[ -z "${WEREAD_API_KEY:-}" && -r "$API_KEY_FILE" ]]; then
./scripts/weread.sh:130:  IFS= read -r WEREAD_API_KEY < "$API_KEY_FILE"
./scripts/weread.sh:131:  export WEREAD_API_KEY
./scripts/weread.sh:134:if [[ -z "${WEREAD_API_KEY:-}" ]]; then
./scripts/weread.sh:135:  echo "缺少 WEREAD_API_KEY。请运行 scripts/setup_api_key.py，或临时 export WEREAD_API_KEY=<your-api-key>。" >&2
