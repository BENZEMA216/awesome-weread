...
| [lovekeji-ai/agent-weread-skill](https://github.com/lovekeji-ai/agent-weread-skill) | Hermes / OpenClaw | Note export Skill with recent-day filtering and safe defaults for routine &ldquo;sync the last N days&rdquo; runs. | [Summary](docs/promo/runs/2026-05-26/lovekeji-ai-agent-weread-skill/summary.md) · [Artifact](docs/promo/runs/2026-05-26/lovekeji-ai-agent-weread-skill/artifacts/terminal-output.txt) |
| [dongwei6688/weread-notes-export-skill](https://github.com/dongwei6688/weread-notes-export-skill) | Hermes / OpenClaw / Cross-runtime | Export bookmarks and reviews as chapter-structured Markdown. Supports incremental sync, same-name book splitting by author, and auto-separator formatting. Zero-dependency Python stdlib. |
...
| [chanity256/weread-export](https://github.com/chanity256/weread-export) | macOS / Markdown / Obsidian | A macOS scheduled exporter that scans completed annotated books daily and writes highlights, thoughts, and reviews into Obsidian-compatible Markdown. | [Summary](docs/promo/runs/2026-06-08/chanity256-weread-export/summary.md) · [Artifact](docs/promo/runs/2026-06-08/chanity256-weread-export/artifacts/sample-export.md) |
| [a3100821009/weread-to-notion](https://github.com/a3100821009/weread-to-notion) | Python, Notion | Sync your WeChat Read bookshelf, highlights, thoughts, and reading statistics to Notion. | [Summary](docs/promo/runs/2026-06-02/a3100821009-weread-to-notion/summary.md) · [Artifact](docs/promo/runs/2026-06-02/a3100821009-weread-to-notion/artifacts/candidate-evidence.md) |
...
| [chucan1/weread-to-getnote](https://github.com/chucan1/weread-to-getnote) | Get Note | Claude Code Skill that formats WeRead highlights and thoughts for Get Note, then recommends a knowledge base. | [Summary](docs/promo/runs/2026-05-29/chucan1-weread-to-getnote/summary.md) · [Artifact](docs/promo/runs/2026-05-29/chucan1-weread-to-getnote/artifacts/getnote-import-preview.md) |
